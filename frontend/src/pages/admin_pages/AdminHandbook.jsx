// src/pages/admin_pages/AdminHandbook.jsx
        ...
        <div className="p-6">
            ...
            <div className="mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">AI Handbook</h1>
                        <p className="text-gray-600">Your compliance and security knowledge base</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    {/* Common Topics */}
                    <div className="bg-white rounded-lg shadow-lg p-6">
                        <h2 className="text-xl font-bold text-gray-900 mb-4">Common Topics</h2>
                        <div className="flex flex-wrap gap-2">
                            {topics.map(topic => (
                                <button
                                    key={topic}
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white rounded-lg shadow-lg flex flex-col" style={{ height: 'calc(100vh - 12rem)' }}>
