      ...
      <div>
        ...
        <div className="flex flex-col-reverse md:flex-row justify-center gap-10 text-center">
          ...
          <div className="flex flex-col pr-0 md:pr-10 mx-auto md:mx-0 md:max-w-none w-auto md:w-[35%] justify-center pt-10 font-sans text-white">
            ...
            <h2 className="text-2xl font-semibold pb-3 ">Sign in or create your account</h2>
            <input className="input validator bg-slate-800 border-black text-white mb-3 w-full" type="email" required placeholder="mail@site.com" />
            {/* Continue Button */}
            <button
              //onClick={}
            ...
            <h2 className="text-xl font-semibold pb-3 ">or<br/>Other ways to login</h2>
