...
class DynamoDBCredentialManager:
    ...
    def store_credentials(
        ...
        try:
            ...
            print(f"Error storing credentials: {type(e).__name__}")
            return False
    ...
    def list_org_credentials(self, org_id: str) -> List[Dict]:
        ...
        try:
            ...
            print(f"Error listing credentials: {type(e).__name__}")
            return []
    ...
    def delete_credentials(
        ...
        try:
            ...
            print(f"Error deleting credentials: {type(e).__name__}")
            return False
    ...
    def get_user(self, org_id: str, user_id: str) -> Optional[Dict]:
        ...
        try:
            ...
            print(f"Error getting user: {type(e).__name__}")
            return None
    ...
    def find_user_by_email(self, email: str) -> Optional[Dict]:
        ...
        try:
            ...
            print(f"Error finding user: {type(e).__name__}")
            return None
    ...
    def store_api_key(
        ...
        try:
            ...
            print(f"Error storing API key: {type(e).__name__}")
            return False
    ...
    def validate_api_key(self, api_key: str) -> Optional[Dict]:
        ...
        try:
            ...
            print(f"Error validating API key: {type(e).__name__}")
            return None
    ...
    def _log_action(
        ...
        print( f"[AUDIT] action={action} resource={resource_id}")
    ...
    for table_def in tables:
        try:
            ...
            if e.response['Error']['Code'] == 'ResourceInUseException':
                ...
                print(f"❌ Error creating {table_def['name']}: {type(e).__name__}")
